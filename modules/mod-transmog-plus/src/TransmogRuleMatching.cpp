...
namespace
{
// Inventory-type exceptions cover ranged weapons and compatible hand-slot combinations.
    bool IsInvTypeMismatchAllowed(ItemTemplate const* source, ItemTemplate const* target)
    {
        ...
        // AllowMixedWeaponTypes: 0 is strict, 1 uses modern weapon groups, 2 allows all types.
...
// Subclass exceptions apply configured armor, weapon, offhand, and tier policies.
...
// Combine general item rules with the configured mismatch exceptions.
